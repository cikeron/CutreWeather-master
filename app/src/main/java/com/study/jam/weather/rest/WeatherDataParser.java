...
public class WeatherDataParser {
    ...
    public ArrayList<Weather> getWeatherDataFromJson(String forecastJsonStr)
        ...
        final String OWM_ESTADO = "main";
        final String OWM_HUMEDAD= "humidity";
        ...
        for(int i = 0; i < weatherArray.length(); i++) {
            String day, description, humedad, descripcion2;
            ...
            description = weatherObject.getString(OWM_ESTADO);
            descripcion2 = weatherObject.getString(OWM_DESCRIPTION);
            humedad=dayForecast.getString(OWM_HUMEDAD);
            ...
            //Creamos un nuevo Weather, con el primer parametro vacio, solo usado para la BD local.
            data.add(new Weather("",day,description,descripcion2,String.valueOf(high),String.valueOf(low),humedad));
        }
