...
public class WeatherService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        */
        ...
        String locationQuery = intent.getStringExtra(LOCATION_QUERY_EXTRA);//Caceres:2520610

        final String API_URL = "http://api.openweathermap.org/data/2.5/forecast/daily?q="
                + locationQuery
                + "&mode=json&units=metric&cnt=7&appid=381bdcc454a4b9678f11fdb192cca4ad&lang=es";
